...
const StrategicPartnerships = () => {
  return (
    <section className="pt-16 pb-24 bg-cover bg-center bg-no-repeat w-full" 
     style={{ backgroundImage: "url('/images/bg-ab.jpg')" }}>

      <div className="container px-4 md:px-8 relative z-10 text-start">
